...
class Graph2Gauss_Torch(nn.Module):
    ...
    def forward(self, input, edge_list):
        ...
        feature_in_list = [input[:,i,:] for i in range(self.lookback+1)]          #  (96,3,96) --> [(96,96), (96,96), (96,96)]
        feature_out_list = []
        for i in range(self.lookback + 1):
            feature_out_list.append(self.gcn(feature_in_list[i], edge_list[i]))   # [(96,96), (96,96), (96,96)] -->[(96,256), (96,256), (96,256)]
