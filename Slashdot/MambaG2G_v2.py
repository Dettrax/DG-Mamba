...
class MambaG2G(torch.nn.Module):
    def __init__(self, config, lin_dim, dim_out,dim_val, dropout=0.2):
        ...
        nn_model = Sequential(Linear(dim_val, dim_val), ReLU(), Linear(dim_val, dim_val))
        self.conv = ApplyConv(self.conv_mamba,dropout,dim_val, GINEConv(nn_model))
        ...
        self.edge_emb = Embedding(2, dim_val)
...
lookback = 2
print(optimise_mamba(data,lookback,lin_dim=28,d_conv=5,d_state=2,dropout=0.44539,lr=2.7608713668855892e-05,weight_decay=0.0001580))
